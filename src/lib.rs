// src/lib.rs
/*
 * Core library for AnimeTabulator
 */
...
#[derive(Debug)]
pub struct AnimeTabulatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeTabulatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeTabulator processing");
    
    let mut processor = AnimeTabulatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeTabulatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeTabulatorProcessor::new(false);
